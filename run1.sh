...
CUDA_VISIBLE_DEVICES=0,1 python scripts/train_cls.py \
    ...
    --show_interval=50 \
    --test_list='VOC2012_list/val_cls.txt'

# Evaluation pseudo segmentation labels generated by the classifier
# CUDA_VISIBLE_DEVICES=0 python scripts/test_cls.py \
#     --checkpoint=checkpoints/DRS_learnable/best.pth --img_dir=/dataset/WSSS/VOC2012/ --test_list='VOC2012_list/val_cls.txt'
...
#    --checkpoint=checkpoints/Refine_DRS_learnable/best.pth --img_dir=/dataset/WSSS/VOC2012/ --test_list='VOC2012_list/val_cls.txt'
